...
ActiveRecord::Schema[7.1].define(version: 2024_02_09_225322) do
  ...
  create_table "cases", force: :cascade do |t|
    ...
    t.index ["challenge_id"], name: "index_cases_on_challenge_id"
  end
  ...
  add_foreign_key "cases", "challenges", on_delete: :cascade
